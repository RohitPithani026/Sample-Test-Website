...
console.log('%c🚀 Welcome to our website!', 'color: #667eea; font-size: 20px; font-weight: bold;');
console.log('%cFeel free to explore the code and customize it to your needs.', 'color: #666; font-size: 14px;');
